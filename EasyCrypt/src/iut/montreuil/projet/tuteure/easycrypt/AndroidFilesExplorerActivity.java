...
public class AndroidFilesExplorerActivity extends ListActivity {
			...
			if (aDirectory.isDirectory()){
				...
				OnClickListener okButtonListener = new OnClickListener(){
					...
					public void onClick(DialogInterface arg0, int arg1) {
							...
							AndroidFilesExplorerActivity.this.openFile(aDirectory);
					}
				};
				...
				alertDialogBuilder.setMessage("Voulez-vous ouvrir ce fichier ?" +aDirectory.getName()).setCancelable(false);
				alertDialogBuilder.setIcon(R.drawable.folder);
				alertDialogBuilder.setPositiveButton("OK", okButtonListener);
				alertDialogBuilder.setNegativeButton("Annuler", cancelButtonListener);
